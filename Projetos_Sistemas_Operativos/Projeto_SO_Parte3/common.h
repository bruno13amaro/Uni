...
#define IPC_KEY 0x0a99437      // KEY para todos os elementos de IPC utilizados. Esta KEY deverá ser substituída pelo nº de aluno
...
#define MAX_VAGAS 1             // Número máximo de cidadãos que poderão estar a ser vacinados simultâneamente
...
#define TEMPO_CONSULTA 30        // Tempo em segundos que leva a realizar uma consulta de vacinação pelo processo Servidor-Filho
#define TEMPO_ESPERA 10          // Tempo em segundos que o Cidadao deverá esperar antes de fazer nova tentativa de consulta
