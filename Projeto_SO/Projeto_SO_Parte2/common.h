...
#define NUM_VAGAS 1       // Número de vagas de cidadãos que poderão estar a ser vacinados simultâneamente
#define TEMPO_CONSULTA 100   // Tempo em segundos que leva a realizar uma consulta de vacinação pelo processo Servidor-Filho
