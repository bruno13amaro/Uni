...
object InitSubScene{
  ...
  Functions.putShapes(OctreeCriacao.tree.getShapes, worldRoot)
  Functions.putParticoes(OctreeCriacao.tree.getCubos, worldRoot)
  ...
  val subScene = new SubScene(worldRoot,500,500,true,SceneAntialiasing.BALANCED)
...
object OctreeCriacao{
  var tree = oct(OcEmpty)
}
